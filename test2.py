...
recipient_phone_number = '19095677744'
...
def create_popup():
    ...
    button5 = tk.Button(popup_window, text="Call 911", command=lambda: screen("911.png"),  compound=tk.CENTER)
...
min_height = 300  # Adjust this value according to your needs
